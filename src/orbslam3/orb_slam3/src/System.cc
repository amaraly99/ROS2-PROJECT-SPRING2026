...
{
    ThreadNaming::NameCurrentThread("orb_track");
...
void System::SaveTrajectoryTUM(const string &filename)
{
    ...
    if(vpKFs.empty())
    {
        cerr << "WARNING: No keyframes available, writing empty camera trajectory." << endl;
        f.close();
        return;
    }
...
void System::SaveKeyFrameTrajectoryTUM(const string &filename)
{
    ...
    if(vpKFs.empty())
    {
        cerr << "WARNING: No keyframes available, writing empty keyframe trajectory." << endl;
        f.close();
        return;
    }
