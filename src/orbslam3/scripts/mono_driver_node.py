...
class MonoDriver(Node):
    def __init__(self, node_name = "mono_py_node"):
        ...
        self.home_dir = str(Path(__file__).resolve().parent.parent) #str(Path.home()) #! Change this to match path to your workspace
        ...
        self.pub_shutdown_name = "/mono_py_driver/shutdown"
    ...
    def run_py_node(self, idx, imgz_name):
        ...
        stamp_ns = int(imgz_name.split(".")[0])
        # ORB-SLAM3 expects timestamps in seconds; EuRoC image names are nanoseconds.
        timestep = stamp_ns / 1e9
        ...
        img_msg.header.stamp.sec = stamp_ns // 1_000_000_000
        img_msg.header.stamp.nanosec = stamp_ns % 1_000_000_000
