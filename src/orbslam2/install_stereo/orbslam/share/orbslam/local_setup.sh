...
: ${AMENT_CURRENT_PREFIX:="/workspace/install_stereo/orbslam"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/orbslam/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/orbslam/environment/path.sh"
